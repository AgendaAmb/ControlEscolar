  ...
  methods: {
    ...
    inputClassFor: function inputClassFor(model) {
      ...
      switch (model) {
        case 'curp':
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1862565227_0", this.NoCurp)));
  ...
  methods: {
    uaslpUser: function uaslpUser() {
      ...
      axios.post('https://ambiental.uaslp.mx/apiagenda/api/users/uaslp-user', data).then(function (response) {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("4126357175_0", res))); // Swal.fire({
  ...
  methods: {
    ...
    registraUsuario: function registraUsuario() {
      ...
      axios({
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("885349525_0", response)));
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("885349525_1", error)));
