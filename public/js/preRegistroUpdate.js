  ...
  methods: {
    miPortalUser: function miPortalUser() {
      ...
      axios.post('/controlescolar/users/miPortalUser', data).then(function (response) {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2546406480_0", res)));
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2546406480_1", err.response.data)));
  ...
  methods: {
    ...
    registraUsuario: function registraUsuario() {
      ...
      axios({
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2460206460_0", response.data)));
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2460206460_1", response.data))); //alert(error.response.data);
