...
<student-appliance ref="appliance" :countries.sync="Countries" 
    ...
    <template v-slot:datos_solicitud>
        ...
        <form-select id="PaisEstudios" clase="form-group col-md-6" v-bind:options="Countries" v-on:update:selected_index="cambiaPaisEstudios"> 
        ...
        <form-input id="PuntajeEXANI" v-model="PuntajeEXANI" clase="form-group col-md-6"> Puntaje EXANI III: </form-input>
            
        <div class="col-12"></div>

        <form-select id="ExamenIngles" clase="form-group col-md-6" 
                    v-bind:options="EnglishExams" v-on:update:selected_index="cambiaExamenIngles"> 
                    Examen de inglés:
        </form-select>

        <form-select id="TipoExamenIngles" clase="form-group col-md-6" 
                    v-bind:options="EnglishExamTypes" v-on:update:selected_index="cambiaTipoExamenIngles"> 
