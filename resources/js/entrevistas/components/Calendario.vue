    ...
    <header class="v-cal-header">
      <div class="v-cal-header__actions">
        ...
        <div class="actions-right">
          <button class="v-cal-button" v-for="(view, index) in availableViews" :key="index" @click="switchView(view)" :class="{ 'v-cal-button--is-active': activeView === view }" >{{ labels[view] | capitalizeFirstLetter }}</button>
        </div>
      </div>
