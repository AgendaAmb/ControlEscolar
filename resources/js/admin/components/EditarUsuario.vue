<template>
  <div class="modal fade"  :class="{ 'is-active': active }">
    <div class="modal-dialog modal-xl">
      <div class="px-2 modal-content px-xl-5 px-lg-5 px-md-4 px-sm-3" style="background-color: #8b96a8">
        <div class="modal-header">
          ...
          <button type="button" class="close mx-2 my-2" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body">
          <form v-on:submit.prevent="actualizaUsuario">
            <div class="row">
              <div class="col-md-4">
                <label> RPE de trabajador </label>
                <input type="number" class="form-control" v-model="id" :readonly='true'>
              </div>
            </div>
            <div class="row">
...
export default {
    ...
    actualizaUsuario() {
        axios.post('/controlescolar/admin/updateWorker', {
            ...
            selected_academic_comittes: this.selected_academic_comittes
             ...
             Swal.fire({
                title: "El usuario con el id " + id + " ha sido modificado",
                icon: "success",
  ...
  created() {
    Event.$on('toggleModal', (id,roles,academic_areas,academic_entities, academic_commites) => {
      this.id = id;
      this.selected_academic_areas = academic_areas,
      this.selected_roles = roles,
      this.selected_academic_entities = academic_entities,
      this.selected_academic_comittes = academic_commites
      this.show();
    });
  }
};
