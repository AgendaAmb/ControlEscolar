<template>
  <div class="form-row my-3">
    ...
    <h5 class="form-group col-12 modal-title" id="exampleModalLabel">
      Datos personales
    </h5>
    <div class="form-group col-lg-6">
      ...
      <input
        type="text"
        :class="inputClassFor('curp')"
        v-model="Curp"
        :readonly="NoCurp === true || Readonly"
      />
    ...
    <!-- Edad -->
    <div class="col-md-6">
      <label class="d-block mt-3"> Edad </label>
      <input
        type="text"
        :class="inputClassFor('age')"
        v-model="Age"
        :readonly="readonly"
      />
      <div v-if="'last_surname' in errores" class="invalid-feedback">
    ...
    <div v-if="CivicState === 'Otro'" class="col-lg-6 mt-3">
      <label>Indica tu estado civil </label>
      <input
        type="text"
    ...
    <div class="col-lg-6 mt-3">
      <!-- Se elige pais manualmente -->
      <div v-if="myResidenseStates.length <= 0">
          <label class="mt-3"> Estado de residencia </label>
          <select v-model="ResidenseState" :class="inputClassFor('birth_state')">
            <option value="" selected>Escoge un estado</option>
            <option v-for="state in states" :key="state.id" :value="state.name">
              {{ state.name }}
            </option>
      ...
      <div v-else>
          ...
          <select v-model="ResidenseState" :class="inputClassFor('birth_state')">
            <option value="" selected>Escoge un estado</option>
            <option v-for="state in myResidenseStates" :key="state.id" :value="state.name">
              {{ state.name }}
            </option>
          </select>
          <div v-if="'birth_state' in errores" class="invalid-feedback">
    ...
    <div v-if="IsDisabled === true" class="col-md-6 col-lg-3 mt-3">
      ...
      <input
        v-model="Disability"
        type="text"
        :class="inputClassFor('disability')"
        :readonly="Readonly"
      />
      <div v-if="'disability' in errores" class="invalid-feedback">
        {{ errores.disability }}
      </div>
    </div>
