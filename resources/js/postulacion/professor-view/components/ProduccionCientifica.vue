    ...
    <details class="mt-1">
        ...
        <div class="row mx-2">
            ...
            <div class="col-12">
                <label>
                    <strong>Nota: </strong>
                    Para poder registrar los cambios en los campos anteriores de
                    la publicación correspondiente es necesario seleccionar el
                    siguiente botón, de esta forma podremos guardar la
