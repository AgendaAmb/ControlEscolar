    ...
    <details open class="c-center-nch">
      ...
      -->
                    ...
                    <div class="row" v-if="degree_type === 'Maestría'">
                        ...
                        <div class="form-group col-md-4">
                            <label>
                                ¿Cuentas con una carta de reconocimiento?
                            </label>
                            <select
                        ...
                        <div class="form-group col-md-4">
                            <label>
                                ¿Cuentas con tu firma electrónica del CONACYT?
                            </label>
                            <select
      ...
      -->
            ...
            <div
                class="d-flex justify-content-start mt-0 mb-3"
                style="width: 100%"
            >
                <div
                ...
                <div class="col-md-10 col-xs-9 mx-3">
                    <label>
                        <strong>Nota: </strong>
                        Para poder guardar los cambios en los campos anteriores
                        del historial académico es necesario seleccionar el
                        siguiente botón.
                        <p>
                            <strong
                                >Solo se guardara el historial académico</strong
                            >
                        </p>
                    </label>
                </div>
