    ...
    <details open>
        ...
        >
            <div class="col-lg-8 col-md-6 col-xs-12">
                ...
                <span v-else class="h5 font-weight-bold"
                    >Publicación {{ index }}</span
                >
            </div>
        ...
        <b-card-body>
                    ...
                    >
                        <div class="form-group col-md-6">
                            ...
                            <select v-model="Type" class="form-control">
                                ...
                                <option value="published_books">
                                    Publicación de libros
                                </option>
                                <option value="published_chapters">
                                    Capítulos publicados
                                </option>
                                <option value="technical_reports">
                                    Reportes técnicos
                                </option>
                                <option value="working_memories">
                                    Memorias de trabajo
                                </option>
                                <option value="working_documents">
            ...
            <div class="d-flex justify-content-start my-2" style="width: 100%">
                ...
                >
                    <button
                        class="uaslp-btn"
                        @click="guardaProduccionCientifica"
                    >
            ...
            style=" max-height: 45px !important;"> -->
                ...
                <div class="col-md-10 col-xs-9 mx-3">
                    <label>
                        ...
                        anteriores es necesario seleccionar el siguiente botón.
                        <p>
                            <strong
                                >Solo se guardara la producción científica
                                actual.</strong
                            >
                        </p>
                    </label>
