                            ...
                            <div class="col-12 my-2">
                                <div class="row my-2 mx-2">
                                    <div class="my-2 col-4">
                                        ...
                                        <ul class="list-group">
                                            <li
                                                v-for="etiqueta in selected_personalDocuments"
                                                :key="etiqueta.id"
                                                class="form-check"
                                            >
                                ...
                                <div class="row my-2 mx-2">
                                    ...
                                    <div
                                        v-if="
                                            requiereWorkingExperience() === true
                                        "
                                        class="my-2 col-4"
                                    >
                                        ...
                                        <ul
                                            class="list-group"
                                            v-for="(
                                                working_experience, index
                                            ) in working_experiences"
                    ...
                    .then((response) => {
                        axios
                            .post(
                                ...
                                {
                                    selected_personalDocuments:
                                        this.selected_personalDocuments,
                                    selected_academicDocuments:
                                        this.selected_academicDocuments,
                                    selected_entranceDocuments:
                                        this.selected_entranceDocuments,
                                    selected_languageDocuments:
                                        this.selected_languageDocuments,
                                    selected_workingDocuments:
                                        this.selected_workingDocuments,
