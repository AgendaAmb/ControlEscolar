    ...
    <div class="row justify-content-start align-items-center mx-1 c-center-nch">
        ...
        <div v-if="isENREM() === true" class="col-12 mt-3">
            <b-form-group
                ...
                label-size="lg"
                label="Idioma"
                label-class="p d-flex my-auto align-items-center text-center justify-content-center"
                label-for="input-sm"
            ...
            >
                ...
                >
                    <b-card-body class="c-center-nch">
                        ...
                        <div
                            class="row align-items-center mt-0 c-center-nch a-start"
                        >
                            <div class="col-lg-12">
                                <button
                                    class="uaslp-btn"
                        ...
                        >
                            <div class="col-lg-12">
                                <button
                                    ...
                                    v-b-popover.hover="
                                        'Agregar una nueva lengua al registro'
                                    "
                                    title="Inserta otro registro"
                                >
                                    <font-awesome-icon
                ...
                >
                    <b-card-body>
                        ...
                        <div class="col-lg-12">
                            <p class="h4">
                                <strong>
                                    Producción científica (Opcional)
                                </strong>
                            </p>
                        </div>
                        ...
                        <produccion-cientifica
                            ...
                            :post_title_memory.sync="
                                production.post_title_memory
                            "
                            :post_title_document.sync="
                                production.post_title_document
                            "
                            :post_title_review.sync="
                                production.post_title_review
                            "
                        ...
                        <div class="col-lg-12 my-2 c-center-nch a-start">
                            <button
                                class="uaslp-btn"
                        ...
                        <div class="col-lg-12 my-2">
                            <p class="h4">
                                <strong>
                                    Capital humano (Cursos impartidos)
                                    [Opcional]
                                </strong>
                            </p>
                        </div>
                        <capital-humano
                            ...
                            :scolarship_level.sync="
                                humanCapital.scolarship_level
                            "
                            :images_btn="images_btn"
