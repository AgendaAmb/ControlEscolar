            ...
            <div class="row my-2 mx-2">
                <div class="col-12 my-2">
                    <textarea
                        ...
                        title="¿Por qué este mensaje?"
                        v-b-popover.hover="
                            'Este mensaje sera añadido a un correo que se mandara al postulante para indicar claramente los errores en los documentos seleccionados'
                        "
...
export default {
    ...
    methods: {
        enviarActualizacion() {
            ...
            if (this.archive_id != null && this.user_id != null) {
                Swal.fire({
