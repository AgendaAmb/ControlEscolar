<template>
    <div class="d-block">
        ...
        >
            <div class="col-md-12">
                <label>
                    Explica los motivos, por los cuales deseas aplicar al
                    programa académico
                </label>
                <textarea
                    v-model="Motivation"
        ...
        <div class="d-flex justify-content-end my-4" style="width: 100%">
            ...
            <div class="col-md-10 col-xs-9 mx-3">
                <label>
                    <strong>Nota: </strong>
                    Para poder registrar los cambios del campo anterior es
                    necesario seleccionar el siguiente botón.
                    <p>
                        <strong
                            >Solo se guardara la exposición de motivos.</strong
                        >
                    </p>
                </label>
            </div>
