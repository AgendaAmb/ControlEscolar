      ...
      <div class="row my-2">
        <div class="col-6">
          ...
          <select v-model="TypeRL" class="form-control">
            ...
            <option
              v-for="item in typesRecommendationLetter"
              :key="item"
              :value="item"
            >
              {{ item }}
    ...
    <div class="col-12">
      <div class="row my-2">
        <div class="col-lg-2 col-sm-4">
          <button class="uaslp-btn" @click="updateLettersOfRecommendation">
  ...
  data: function () {
    return {
      ...
      options_financing: [
        "Self-funded",
        "Salary will be paid",
        "Goberment Study Grant",
        "I intend to apply for a CONACYT or DAAD scholarship",
        "I intented to apply for an external scholarship",
        "Other",
      ],
    };
  },
