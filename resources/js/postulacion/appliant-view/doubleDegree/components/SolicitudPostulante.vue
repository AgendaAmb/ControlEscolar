    ...
    <div class="row justify-content-start align-items-center mx-1 c-center-nch">
        ...
        <div class="col-12 width-85">
            <b-card
                no-body
                class="my-2"
                :style="styleContainerAccordionSection"
            >
                <b-card-header
                    header-tag="header"
                    class="p-1"
                ...
                >
                    <b-card-body>
                        <higher-education
                            ...
                            :id="grado.id"
                            :archive_id="archive_id"
                            :final_grade_average.sync="
                                grado.final_grade_average
                            "
                            :graduation_mode.sync="grado.graduation_mode"
                            :fill_according_graduation.sync="
                                grado.fill_according_graduation
                            "
                            ...
                            :date_of_award_of_degree.sync="
                                grado.date_of_award_of_degree
                            "
                ...
                >
                    <b-card-body>
                        <language-skills
                            ...
                            :duration_in_months.sync="
                                language.duration_in_months
                            "
                            :country.sync="language.country"
                            :overal_grade_score.sync="
                                language.overal_grade_score
                            "
                            :language_domain.sync="language.language_domain"
                            :conversational_level.sync="
                                language.conversational_level
                            "
                ...
                >
                    <b-card-body>
                        <working-experiece
                            v-for="(
                                experience, index
                            ) in appliant_working_experiences"
                            v-bind="experience"
                ...
                >
                    <b-card-body>
                        <future-plans-expectations
                            ...
                            :explain_pursue_future.sync="
                                plansEx.explain_pursue_future
                            "
                        ></future-plans-expectations>
                    </b-card-body>
                </b-collapse>
                ...
                >
                    <b-card-body>
                        <fiels-of-interest
                            ...
                            :archive_id="archive_id"
                            :id="foi.id"
                            :keywords_proyect_idea.sync="
                                foi.keywords_proyect_idea
                            "
                            :proyect_idea.sync="foi.proyect_idea"
                            :research_area_mexico.sync="
                                foi.research_area_mexico
                            "
                            :research_area_german.sync="
                                foi.research_area_german
                            "
                            :professor_research_german.sync="
                                foi.professor_research_german
                            "
                            :professor_research_mexico.sync="
                                foi.professor_research_mexico
                            "
                ...
                >
                    <b-card-body>
                        <letters-of-recommendation
                            v-for="(
                                rl_enrem, index
                            ) in recommendation_letter_enrem"
                            v-bind="rl_enrem"
...
export default {
    ...
    mounted: function () {
        this.$nextTick(function () {
            axios
                .get(
                    "https://ambiental.uaslp.mx/apiagenda/api/countries/universities"
                )
                .then((response) => {
