    ...
    <details open>
        <summary class="btn row d-flex align-items-center justify-content-center my-2"
            ...
            <div class="col-lg-9 col-sm-6">
                ...
                <span class="h5 font-weight-bold" style="width:auto!important;">Language Skills {{ index + 1 }}</span>
            </div>
        ...
        <b-card-body>
            <div class="form-group col-12 my-2">
                ...
                <div v-if="selectedIsEnglish() === true" class="row my-2">
                    ...
                    <div class="form-group col-lg-4 col-sm-6">
                        ...
                        <select v-model="KindOfExam" class="form-control">
                            <option value="" selected>Choose an option</option>
                            <option v-for="typeExName in kindsOfExamsGeneral" :key="typeExName" :value="typeExName">
                                {{ typeExName }}
                            </option>
                        </select>
                ...
                <div v-else-if="selectedIsSpanish() === true" class="row my-2">
                    <div class="col-12">
                        <label class="h4">Spanish Proficiency (for non-native Spanish speaking
                            Appliants)</label>
                    </div>
                    <div class="form-group col-lg-8 col-sm-6">
                        ...
                        <select v-model="LearningMethod" class="form-control">
                            <option value="" selected>Choose an option</option>
                            <option v-for="lm in listLearningMethodSpanish" :key="lm" :value="lm">
                                {{ lm }}
                            </option>
                        </select>
                ...
                <div v-else class="row my-2">
                    <div class="col-12">
                        <label class="h4">German Proficiency (for non German Appliant)</label>
                    </div>
                    <div class="form-group col-lg-8 col-sm-6">
                        <label>Learning method</label>
                        <!-- Solo se podra seleccionar para doctorado -->
                        <select v-model="LearningMethod" class="form-control">
                            <option value="" selected>Choose an option</option>
                            <option v-for="lm in listLearningMethodGerman" :key="lm" :value="lm">
                                {{ lm }}
                            </option>
                        </select>
                ...
                <div class="row my-2">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        ...
                        <input v-model="OveralGradeScore" type="number" class="form-control">
                    </div>
                </div>
