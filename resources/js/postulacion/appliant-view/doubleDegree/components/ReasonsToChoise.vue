<template>
    ...
    <div class="row">
        ...
        <div class="row my-2">
            <div class="col-12">
                <label class="h3"
                    >Why did you decide to study the ENREM master's degree?
                    (Multiple choice is possible)</label
                >
        ...
        actualizaLista(label, value, res) {
            ...
            if (this.selected_choises_list.length <= 0 && res) {
                ...
                if (!res) {
                    ...
                    if (index < 0) {
                        this.selected_choises_list.push({
                            label: label,
                            value: value,
                        });
                    }
            ...
            axios
                .post(
                    "/controlescolar/solicitud/enrem/reasonsToChoise/update",
                    {
                        ...
                        selected_choises: JSON.stringify(
                            this.selected_choises_list
                        ),
                    }
                )
                .then((response) => {
