...
class SendTeamsMeeatingInformationProfesor extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($correo, 'DETALLES DE ENTREVISTA')->view('Correos.MeetingTeamsProfesor')->subject('Información de entrevista');
    }
}
