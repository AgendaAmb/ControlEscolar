...
class SendTeamsMeeatingInformation extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($correo, 'DETALLES DE ENTREVISTA')->markdown('Correos.MeetingTeamsPostulante')->subject('Información de entrevista');
    }
}
