...
class SendRejectPostulation extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($correo, 'Resultados de postulación')->markdown('Correos.ShowRejectPostulation')->subject('Estado de posgrado solicitado');
